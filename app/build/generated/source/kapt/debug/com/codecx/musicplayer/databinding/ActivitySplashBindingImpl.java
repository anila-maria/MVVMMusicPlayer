...
public class ActivitySplashBindingImpl extends ActivitySplashBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.splash_iv, 4);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.versionName == variableId) {
            setVersionName((java.lang.String) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setVersionName(@Nullable java.lang.String VersionName) {
    ...
    protected void executeBindings() {
        ...
        java.lang.String versionName = mVersionName;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.versionNumber, versionName);
        }
    }
